...
async function getCommits() {
  ...
  const res = await fetch('https://api.github.com/repos/13289528036/xuejuan/commits', { // 修改了这里的 URL
...
export default async function GitHubStatsPage() {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">GitHub: 13289528036/xuejuan 提交记录</h1> {/* 修改了这里的仓库名称 */}
